...
function r_enqueue_scripts(){
    ...
    wp_register_script('r_rate_post_share_js', plugins_url('/assets/js/share-post.js', RATE_POSTS_PLUGIN_URL), [ 'jquery' ], false, true);
    ...
    wp_enqueue_script('r_rate_post_share_js');
}